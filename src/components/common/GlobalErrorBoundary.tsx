...
import { AppErrorHandler, ErrorCategory, ErrorSeverity } from '../../utils/errorHandling';
  ...
  override componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    const appError = AppErrorHandler.createError(
      ...
      ErrorSeverity.HIGH,
      {
        ...
        userMessage: 'The application encountered an unexpected error. Please refresh the page and try again.'
      }
    );
